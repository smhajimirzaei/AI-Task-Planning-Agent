"""AI Planning Agent powered by Claude for intelligent task scheduling."""
...
class AIPlannerService:
    """AI-powered planning service using Claude."""

    def __init__(self):
        """Initialize AI planner with Claude client."""
    ...
    def generate_plan(
        ...
        """
        Generate an optimal task schedule plan using Claude.
        ...
        try:
            ...
            print(f"Error generating plan with Claude: {e}")
            raise
...
"""
    ...
    def _build_planning_prompt(
        ...
        """Build the comprehensive planning prompt for Claude."""
...
"""
    ...
    def _parse_plan_response(self, response_text: str) -> TaskPlan:
        """Parse Claude's response into a structured TaskPlan."""
        try:
